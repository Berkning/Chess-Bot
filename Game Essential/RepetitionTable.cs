...
public class RepetitionTable
{
    ...
    {
        //if (currentIndex < 0 || currentIndex >= hashes.Length) Console.WriteLine("bestmove repetitionTableBoundsViolation:" + currentIndex); //TODO: Add with conditional compilation with DEBUG
